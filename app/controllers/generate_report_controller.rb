class GenerateReportController < ApplicationController
    ...
    def generate ## evac_centers/1/:disaster/generate
        ...
        wb.add_worksheet(name: 'Merge cells') do |sheet|
            ...
            sheet.add_row ["EVACUATION CENTER", @evac_center.name, "ADDRESS","#{@evac_center.barangay}, Naga City, Camarines Sur"]
            #
            sheet.add_row ["NOTED BY"]
            sheet.add_row []
            sheet.sheet_view.pane do |pane|
                pane.top_left_cell = "A7"
                pane.state = :frozen_split
                pane.y_split = 6
                pane.x_split = 0
                pane.active_pane = :bottom_right
            end
            sheet.add_row ["Age Range", "No. Of MALEs","", "No. Of FEMALEs",""]
            sheet.add_row ["", "CUM", "NOW", "CUM", "NOW"]
            sheet.add_row ["INFANT", helpers.ggetInfants(@evac_center.id, @disaster.id,"Male", false),helpers.ggetInfants(@evac_center.id, @disaster.id,"Male", true),helpers.ggetInfants(@evac_center.id, @disaster.id,"Female", false),helpers.ggetInfants(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["TODDLER", helpers.ggetToddlers(@evac_center.id, @disaster.id,"Male", false), helpers.ggetToddlers(@evac_center.id, @disaster.id,"Male", true),helpers.ggetToddlers(@evac_center.id, @disaster.id,"Female", false),helpers.ggetToddlers(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["PRESCHOOLERS",helpers.ggetPreschoolers(@evac_center.id, @disaster.id,"Male", false),helpers.ggetPreschoolers(@evac_center.id, @disaster.id,"Male", true),helpers.ggetPreschoolers(@evac_center.id, @disaster.id,"Female", false),helpers.ggetPreschoolers(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["SCHOOLAGERS",helpers.ggetSchoolagers(@evac_center.id, @disaster.id,"Male", false),helpers.ggetSchoolagers(@evac_center.id, @disaster.id,"Male", true),helpers.ggetSchoolagers(@evac_center.id, @disaster.id,"Female", false),helpers.ggetSchoolagers(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["TEENAGERS",helpers.ggetTeenagers(@evac_center.id, @disaster.id,"Male", false),helpers.ggetTeenagers(@evac_center.id, @disaster.id,"Male", true),helpers.ggetTeenagers(@evac_center.id, @disaster.id,"Female", false),helpers.ggetTeenagers(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["ADULTS",helpers.ggetAdults(@evac_center.id, @disaster.id,"Male", false),helpers.ggetAdults(@evac_center.id, @disaster.id,"Male", true),helpers.ggetAdults(@evac_center.id, @disaster.id,"Female", false),helpers.ggetAdults(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["SENIORS",helpers.ggetSeniors(@evac_center.id, @disaster.id,"Male", false),helpers.ggetSeniors(@evac_center.id, @disaster.id,"Male", true),helpers.ggetSeniors(@evac_center.id, @disaster.id,"Female", false),helpers.ggetSeniors(@evac_center.id, @disaster.id,"Female", true)]
            sheet.add_row ["TOTAL",helpers.gcountGenderEvacuated(@evac_center.id,@disaster, "Male", false),helpers.gcountGenderEvacuated(@evac_center.id,@disaster, "Male", true),helpers.gcountGenderEvacuated(@evac_center.id,@disaster, "Female", false),helpers.gcountGenderEvacuated(@evac_center.id,@disaster, "Female", true)]
            ##RELIEF
            sheet.add_row [""]
            sheet.add_row [""]
            ...
            sheet.add_row [""]
            sheet.add_row [""]
            sheet.add_row ["EVACUATION CENTER FACILITIES"]
            sheet.add_row [""]
            sheet.add_row ["NAME", "TYPE", "DESCRIPTION", "QUANTITY", "QUALITY"]
            @essFaci.each do |rlG|
                sheet.add_row rlG
            end
    ...
    def generate_all # disasters/1/generate
        ...
        wb.add_worksheet(name: 'Merge cells') do |sheet|
            ...
            sheet["B5:F7"].each do |cell|
                cell.style = wb.styles.add_style({bg_color:"c5e0b3"})
            end
            sheet["K5:AL7"].each do |cell|
                cell.style = wb.styles.add_style({bg_color:"fef2cb"})
            end
            
            sheet["G5:J7"].each do |cell|
                cell.style = wb.styles.add_style({bg_color:"93c47d"})
            end
            sheet["AM5:AP7"].each do |cell|
                cell.style = wb.styles.add_style({bg_color:"f7caac"})
            end
